...
<body>
	...
	<c:if test="${msg == false}">
		<div class="form-group">
			<div class="col-sm-8">
				<h3><span class="label label-danger">로그인에 실패하였습니다. 아이디와 비밀번호를 다시 입력하세요.</span></h3>
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-8">
				<div style="background-color:#CF0; color:red" ><h3>로그인에 실패하였습니다. 아이디와 비밀번호를 다시 입력하세요.</h3></div>
			</div>
		</div>
	</c:if>
	</form>
